...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)->DataFrame:
        '''
        Import data from mongodb database and export into feature store
        '''
        try:
    ...
    def split_data_as_train_test_split(self, dataframe:DataFrame):
        '''
        Split data in feature store as train test split
        '''
        try:
    ...
    def initiate_data_ingestion(self)->DataIngestionArtifact:
        try:
            ...
            dataframe=dataframe.drop(self._schema_config(SCHEMA_FILE_PATH))
