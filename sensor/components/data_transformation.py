...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
       try:
          ...
          preprocessor=Pipeline(steps=[("Imputer",simple_imputer), #replace missing value with 0
                                       ("Transformer",robust_scaler)])#keep every feature in same range and handle outliers
          return preprocessor
       except Exception as e:
          raise SensorException(e,sys)
